...
angular.module('Reachx').constant('DSConstants', {
    ...
    'PAGE_LEAD_SUMMARY': "/leadSummary",
    'PAGE_LEAD_HISTORY': "/leadHistory",
    'PAGE_LEAD_STATUS': "/leadStatus",
    'PAGE_ALL_ACTIVE_DEALS': "/activeDeals",
    'PAGE_ALL_COMPLTED_DEALS': "/completedDeals",
    'PAGE_ALL_REJECTED_DEALS': "/rejectedDeals",
    ...
    'GET_DASHBOARD_USER_LEAD': 'webresources/lead/getDashboardUserLeads',
    'GET_DASHBOARD_LEADS_BY_TYPE': 'webresources/lead/getDashboardLeads',
    'GET_LEAD_HISTORY': 'webresources/lead/getLeadHistory',
    'GET_LEAD_STATUS': 'webresources/lead/getLeadStatusHistory',
    'GET_LEAD_DOCUMENTS': 'webresources/lead/getLeadDocuments',
